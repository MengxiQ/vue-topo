                    ...
                    <div v-else>
                      <el-form label-position="left" label-width="40px" >
                        <el-form-item  label="名称">
                            <el-input v-model="vSelectNodeData['name']"></el-input>
                        </el-form-item>
                        <el-form-item  label="图标">
                          <el-input v-model="vSelectNodeData['icon']"></el-input>
                        </el-form-item>
                        <el-form-item  label="类型">
                          <el-input v-model="vSelectNodeData['type']"></el-input>
                        </el-form-item>
                        <el-form-item  label="高">
                          <el-input v-model="vSelectNodeData['height']"></el-input>
                        </el-form-item>
                        <el-form-item  label="宽">
                          <el-input v-model="vSelectNodeData['width']"></el-input>
                        </el-form-item>
                      </el-form>
                    </div>
                </el-form>
...
#topoAttrWrap{display:flex;flex-direction:column;height:100%;width:400px;position:absolute;top:0;right:-400px;background:#fff;border-left:1px solid darken(@theme-color,10%);transition:all 1s;box-sizing:border-box;
    ...
    .topoAttrBody{flex:1;display:flex;flex-direction:column;
        .topoAttrMain{overflow-y: scroll;padding:20px 15px;box-sizing:border-box;}
