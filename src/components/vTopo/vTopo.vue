...
<!--          </li>-->
          <el-popconfirm
            ...
            @onConfirm='clickSave'
          >
            <el-button icon="el-icon-finished" slot="reference" type="primary" size="mini">保存</el-button>
          </el-popconfirm>
...
<!--      左侧侧边栏-->
      ...
      <v-shapebar :shapeNodeLstData = 'toolBarData' @click="dragShapeNode" v-show="editable"></v-shapebar>

      <div :id="'topoId'+topoId" class="topoWrap" ref="topoWrap" @contextmenu.prevent="RClick">
        <svg class="topoSvg"
          :width="svgAttr.width"
...
export default {
  ...
  data () {
    return {
      ...
      toolBarData: [
      {type:'ApplicationModule', name:'交换机1',  icon:require('@/assets/topo/application.png'),width:50,height:50,num:1,classType:'T2'},
      {type:'ApplicationModule',  name:'交换机2', icon:require('@/assets/topo/application.png'),width:50,height:50,num:1,classType:'T2'},
      {type:'ApplicationModule',  name:'交换机3', icon:require('@/assets/topo/application.png'),width:50,height:50,num:1,classType:'T2'},
      {type:'ApplicationModule',  name:'交换机4', icon:require('@/assets/topo/application.png'),width:50,height:50,num:1,classType:'T2'},
      ],
     keyFormRules:{
      key:[
