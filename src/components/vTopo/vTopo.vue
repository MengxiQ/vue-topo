  ...
  <div class="topoComponent">
    <div class="svgHead" v-show="editable">
      <ul class="svgHeadItemLst">
        <li class="svgHeadItem" v-for="(ele,key) in svgToolbar" :key="ele.className" :class="{'active':ele.isActive}"
            @mousedown="selectToolbar(key)" :title="ele.name">
            ...
            <g
              ...
              **/
              <line
                ...
                :stroke="ele.color"
                :x1='ele.sourceNode.x + (ele.sourceNode.width/2) ' :y1="ele.sourceNode.y + (ele.sourceNode.height/2)"
                :x2="ele.targetNode.x + (ele.targetNode.width/2)" :y2="ele.targetNode.y + (ele.targetNode.height/2)"
              >
    ...
    <div v-if="shapebarMoveNode.isShow" class="moveNode nodeMoveCss"
